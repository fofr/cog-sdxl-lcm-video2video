...
def main():
    ...
    for guidance_scale in [i * 0.01 for i in range(301)]:
        gen(
            f"sample_{str(format(guidance_scale, '.2f')).replace('.', '_')}.png",
            seed=1000,
            width=768,
            height=768,
            prompt="A painting of an astronaut riding a rainbow unicorn",
            num_outputs=1,
            guidance_scale=guidance_scale,
            apply_watermark=False,
            negative_prompt="ugly, distorted, broken, garish",
